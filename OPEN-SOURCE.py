...
def _ex_():
     ...
     sim_name = random.choice(["Banglalink","Robi","Airtel","Grameenphone"])
     mobile_model = random.choice(["SM-T530","SM-G531H","SM-G316M","GT-I9060I","SAMSUNG-SM-N920A","SM-J200F"])
     mobile_version = f"{random.randint(4, 13)}.{random.randint(0, 5)}.{random.randint(1, 5)}"
     fbrv = str(random.randint(000000000,999999999))
     ua = "[FBAN/FB4A;FBAV/480.0.0.0.67;FBBV/455007274;FBDM/{density=1.0,width=1280,height=800};FBLC/en_US;FBCR/"+str(sim_name)+";FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/"+str(mobile_model)+";FBSV/"+str(mobile_version)+";FBOP/1;FBCA/armeabi-v7a:armeabi;]"
     pioo = f'[FBAN/FB4A;FBAV/{fb_version};FBBV/{fb_version_code};'+ua
     return pioo
